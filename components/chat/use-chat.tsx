...
import { CreateMessage, Message, UseChatOptions } from "ai/react";
import { useCallback, useEffect, useId, useRef, useState } from "react";
import useSWR, { KeyedMutator } from "swr";
export type { CreateMessage, Message, UseChatOptions };
import { experimental_StreamingReactResponse } from "ai";
import { processChatStream } from "./process-chat-stream";
...
const getStreamedResponse = async (
  ...
  return await callChatApi({
    ...
    appendMessage(message) {
      //   console.log("messageAppend called", message);

      let newMessage = message;

      mutate([...chatRequest.messages, { ...newMessage }], false);
    },
...
export function useChat({
  ...
  const append = useCallback(
    async (
      ...
      //   console.log("appendCalled with message", message);
